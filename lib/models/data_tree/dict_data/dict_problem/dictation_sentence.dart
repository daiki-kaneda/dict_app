...
part 'dictation_sentence.g.dart';
...
class DictationSentence {
  ...
  //       .map((word) => DictationWord.from(word: word, alphabetOnly: alphabetOnly))
  //       .toList();
  //   return DictationSentence(sentence: sentence, words: words,start: 0,end: 0 );
  // }
...
@JsonSerializable()
class DictationWord {
  const DictationWord({required this.word, required this.characters});
